...
- 🚀 Feature add ticker logo cache from Elbstream API (#146)
- 🚀 Feature add dividend calendar with forecast (#132) ([#145](https://github.com/ablanc0/Investment-Toolkit-App/pull/145))
...
- 🚀 Feature add dividend calendar with forecast (#132)
- 🚀 Feature add geographic and currency diversification (#133) (#144) ([#144](https://github.com/ablanc0/Investment-Toolkit-App/pull/144))
- 🚀 Feature implement 8 Snowball Analytics gap features (#143) ([#143](https://github.com/ablanc0/Investment-Toolkit-App/pull/143))
...
- 🚀 Feature integrate RapidAPI Cost of Living data (#128)
...
- 🚀 Feature Retirement Plan section in Salary tab (#126) ([#126](https://github.com/ablanc0/Investment-Toolkit-App/pull/126))
- 🚀 Feature Tax Accounts tab — HSA Calculator + Expense Tracker (#123) ([#123](https://github.com/ablanc0/Investment-Toolkit-App/pull/123))
...
- 🚀 Feature API key management, light/dark theme toggle, and valuation defaults wiring (#40)
- 🚀 Feature add display preferences, default tab, and cache TTL settings (#102) ([#102](https://github.com/ablanc0/Investment-Toolkit-App/pull/102))
- 🚀 Feature split signal system into IV Signal and Avg Cost Signal (#101) ([#101](https://github.com/ablanc0/Investment-Toolkit-App/pull/101))
- 🚀 Feature goals editor, target allocations, and valuation defaults (#99) ([#99](https://github.com/ablanc0/Investment-Toolkit-App/pull/99))
- 🚀 Feature editable portfolio name and top performer threshold (#93, #97) (#98) ([#98](https://github.com/ablanc0/Investment-Toolkit-App/pull/98))


## 2026-03-06
- 🚀 Feature configurable signal thresholds and default signal mode (#87) (#92) ([#92](https://github.com/ablanc0/Investment-Toolkit-App/pull/92))
- 🚀 Feature configurable category system with Settings UI (#89) ([#89](https://github.com/ablanc0/Investment-Toolkit-App/pull/89))
...
- 📖 Documentation add Sphinx user documentation (formulas, config, data management) (#83) ([#83](https://github.com/ablanc0/Investment-Toolkit-App/pull/83))
...
## 2026-03-05
- 🐛 Fix harden 13F pipeline for future quarterly reports (#68)
- 🐛 Fix sanitize 13F history — remove amendment filings and value outliers (#68)
- ✨ Enhancement rename Warren Buffett → Greg Abel, migrate history key (#68)
- ✨ Enhancement remove 13f_cache, use history as single source of truth (#68)
- 🐛 Fix backfill 13F cache from history on startup (#68)
- 🚀 Feature portfolio value change %, allocation treemap (#68)
- 🚀 Feature activity badges, current prices, and holding history per row (#68)
- 🚀 Feature historical 13F data, portfolio value charts, activity tracking, UI refactor (#68)
- 🚀 Feature expand to 22 super investors, add bio notes, allocation chart, Top 10% badge (#68)
...
- 🐛 Fix InvT Score bug fixes, scoring fairness & UI polish (#44)
...
- 🚀 Feature SEC EDGAR 13F super investor holdings integration (#65)
- 🚀 Feature rethink composite IV — refined categories, benchmarks, Summary tab redesign (#64) ([#64](https://github.com/ablanc0/Investment-Toolkit-App/pull/64))
- 🚀 Feature compact DCF Scenarios layout — side-by-side table, collapsible detail (#60) (#62) ([#62](https://github.com/ablanc0/Investment-Toolkit-App/pull/62))


## 2026-03-04
- ✨ Enhancement rename Endeuda2 to DCF Scenarios across codebase (#58) (#59) ([#59](https://github.com/ablanc0/Investment-Toolkit-App/pull/59))
...
- 🚀 Feature replace FMP with SEC EDGAR as primary data source (#54)
- ✨ Enhancement Graham toggle buttons with active/inactive visual indicator
- 🚀 Feature persist analyzer results to analyzer.json + median toggle (#37)
- 🚀 Feature Finviz peer comparison for Relative valuation (#37)
- 🚀 Feature Relative valuation — FMP-derived ratios, editable sector averages (#37)
- 🚀 Feature Graham improvements — negative EPS warning, presets, FRED date (#42)
- 🚀 Feature Graham — FMP earnings growth + live FRED AAA yield (#42)
- 🚀 Feature Graham model — editable formula, FMP EPS, capped growth (#36)
...
- 🚀 Feature stock analyzer valuation models (DCF, Graham, Relative) (#32) ([#32](https://github.com/ablanc0/Investment-Toolkit-App/pull/32))


## 2026-03-03
- 🚀 Feature portfolio projections with server-side engine, auto-populate, and year-by-year table (#31) ([#31](https://github.com/ablanc0/Investment-Toolkit-App/pull/31))
- 🚀 Feature salary tab — profiles, progressive tax, income streams, employer cost, projections (#28) ([#28](https://github.com/ablanc0/Investment-Toolkit-App/pull/28))
