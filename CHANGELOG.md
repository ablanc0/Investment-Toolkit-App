...
- remove old logos/ directory (moved to data/logos/)

### Testing

- add 54 security tests for issues #46-#49
- add comprehensive test suite with 177 tests
## [0.2.0] — 2026-03-06
...
- update Apps Script — profile endpoint, direct cell writes, cleanup
- Apps Script for FMP data in Google Sheet Stock Analyzer
- FMP API evaluation for Stock Analyzer data source
...
- remove fmp_eval.py — FMP integration now in server.py
- configure conda env (invapp) for start.sh launcher
## [0.1.0] — 2026-03-02
