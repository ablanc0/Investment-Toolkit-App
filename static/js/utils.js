...
function tickerLogo(ticker, size = 20) {
    return `<img src="/api/logo/${encodeURIComponent(ticker)}?v=2" alt="" style="height:${size}px;width:${size}px;border-radius:50%;object-fit:cover;vertical-align:middle;margin-right:4px;" onerror="this.style.display='none'" loading="lazy">`;
}
